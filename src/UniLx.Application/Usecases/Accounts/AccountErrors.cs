...
namespace UniLx.Application.Usecases.Accounts
{
    public static class AccountErrors
    {
        ...
        public static readonly Error ErrorGeneratingPresignUrl = new(System.Net.HttpStatusCode.BadGateway, "Accounts.PresignUrl", "Error when generating presign url for account.");
